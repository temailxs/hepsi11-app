          ...
          <header className="container main-header py-3">
            <div className="d-flex align-items-center">
              <div className="d-flex h-100 align-items-center">
                <button
                  className="btn mx-1 text-black fs-5 open-menu d-block d-md-none"
                >
                  <i className="bi bi-list"></i>
                </button>
                <a href="/" className="text-black fw-bold text-decoration-none fs-3"
                >HEPSİ11.COM</a>
                <div className="mobile-menu position-absolute w-100">
                  <div
                    className="main-mobile-menu w-75 bg-white h-100 p-3 rounded-end-3 shadow-lg border border-3"
                  >
                    <div className="w-100 d-flex align-items-center">
                      <div className="flex-grow-1">Menu</div>
                      <div>
                        <button className="btn fw-bold close-menu">
                    ...
                    <ul className="p-0">
                      ...
                      <li className="mx-2 my-2">
                        <a
                          className="text-decoration-none text-black shop-link"
                          href="shop"
                        >
                          Shop &nbsp;
                        </a>
                ...
                <div className="row d-flex d-md-none">
                  <div className="col-11 mx-1">
                    <form action="" className="">
                      <div
                        className="search-form-main d-flex rounded-pill border border-1 p-2"
                      >
                        <input
                          type="search"
                ...
                <div className="row d-none d-md-flex">
                  <div className="col-7">
                    <form action="" className="d-inline w-100">
                      <div className="d-flex rounded-pill search-form-main p-2">
                        <i
                          className="bi bi-search fs-5 text-secondary d-inline-block"
                        ></i>
                        <input
                          type="search"
                  ...
                  <div className="col-5 d-flex align-items-center">
                    <ul className="header-menu-list">
                      ...
                      <li className="mx-2">
                        <a
                          className="text-decoration-none text-black main-menu-link position-relative shop-link"
                          href="shop"
                        >
                          Shop &nbsp;
                        </a>
            ...
            <div className="container px-3 py-4 rounded-4">
              <div className="row">
                <div className="flex-grow-1 col-md-8 my-3">
                  <h1 className="text-white">Don't miss latest news.</h1>
                </div>
              ...
              <div className="row">
                <div className="my-2 col-12 col-md-4">
                  ...
                  <div className="social d-flex mt-5">
                    ...
                    ></a>
                    <a
                      href="https://t.me/sirmerdas"
                      target="_blank"
                      className="mx-2 social-icon d-flex text-black bg-white rounded-circle justify-content-center align-items-center fs-5"
                    ><i className="bi bi-telegram"></i
                    ></a>
                    <a
                      href="https://instagram.com/sirmerdas"
                      target="_blank"
                      className="mx-2 social-icon d-flex text-black bg-white rounded-circle justify-content-center align-items-center fs-5"
